...
public final class ProtoSphericalCoordinates {
  ...
  public interface SphericalCoordinatesOrBuilder extends
     ...
     * <code>required .gazebo.msgs.SphericalCoordinates.SurfaceModel surface_model = 1;</code>
     */
    cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel getSurfaceModel();
  ...
  public static final class SphericalCoordinates extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel value = cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.internal_static_gazebo_msgs_SphericalCoordinates_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.internal_static_gazebo_msgs_SphericalCoordinates_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.class, cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.Builder.class);
    }
    ...
    public enum SurfaceModel
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel surfaceModel_;
    /**
     * <code>required .gazebo.msgs.SphericalCoordinates.SurfaceModel surface_model = 1;</code>
     */
     ...
     * <code>required .gazebo.msgs.SphericalCoordinates.SurfaceModel surface_model = 1;</code>
     */
    public cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel getSurfaceModel() {
    ...
    private void initFields() {
      surfaceModel_ = cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel.EARTH_WGS84;
      latitudeDeg_ = 0D;
      longitudeDeg_ = 0D;
      elevation_ = 0D;
      headingDeg_ = 0D;
    ...
    public static cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates parseFrom(
    ...
    public static cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates parseFrom(
    ...
    public static cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates prototype) {
    ...
    public static final class Builder extends
        ...
        cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinatesOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.internal_static_gazebo_msgs_SphericalCoordinates_descriptor;
      }
      ...
      public cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates getDefaultInstanceForType() {
        return cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.getDefaultInstance();
      }

      public cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates build() {
        cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates result = buildPartial();
      ...
      public cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates buildPartial() {
        cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates result = new cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates) {
          return mergeFrom((cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates)other);
        } else {
      ...
      public Builder mergeFrom(cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates other) {
        if (other == cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      private cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel surfaceModel_ = cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel.EARTH_WGS84;
      /**
       * <code>required .gazebo.msgs.SphericalCoordinates.SurfaceModel surface_model = 1;</code>
       */
      public boolean hasSurfaceModel() {
       ...
       * <code>required .gazebo.msgs.SphericalCoordinates.SurfaceModel surface_model = 1;</code>
       */
      public Builder setSurfaceModel(cn.autolabor.plugin.gazebo.gazebomsgs.ProtoSphericalCoordinates.SphericalCoordinates.SurfaceModel value) {
        if (value == null) {
